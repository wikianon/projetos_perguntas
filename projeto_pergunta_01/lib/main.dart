...
class PerguntaAppState extends State<PerguntaApp> {
  ...
  void responder() {
    if(perguntaSelecionada < perguntas.length)
    {
      ...
      // perguntaSelecionada without calling setState(), then the build method would not be
        ...
        body: Center(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              //Espaçamento do texto Selecione a Pergunta das perguntas.
              SizedBox(height: 10,),
              Text(
